================================================================================
    MICROSOFT FOUNDATION CLASS LIBRARY : IMEApp Project Overview
===============================================================================

The application wizard has created this IMEApp application for 
you.  This application not only demonstrates the basics of using the Microsoft 
Foundation Classes but is also a starting point for writing your application.

This file contains a summary of what you will find in each of the files that
make up your IMEApp application.
...
IMEApp.h
    ...
    project specific headers and declares the CIMEApp application class.
...
IMEAppDlg.h, IMEAppDlg.cpp - the dialog
    These files contain your CIMEAppDlg class.  This class defines
...
StdAfx.h, StdAfx.cpp
    ...
    named IMEApp.pch and a precompiled types file named StdAfx.obj.
